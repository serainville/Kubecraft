...
import (
	...
	informers "MinecraftServerController/pkg/generated/informers/externalversions"

	MinecraftServerController "MinecraftServerController/pkg/apis/minecraftserver/v1alpha1"

	"MinecraftServerController/pkg/generated/clientset/versioned/fake"
)
...
type fixture struct {
	...
	minecraftServerLister []*MinecraftServerController.MinecraftServer
...
func newFoo(name string, replicas *int32) *MinecraftServerController.MinecraftServer {
	return &MinecraftServerController.MinecraftServer{
		TypeMeta: metav1.TypeMeta{APIVersion: MinecraftServerController.SchemeGroupVersion.String()},
		ObjectMeta: metav1.ObjectMeta{
			Name:      name,
			Namespace: metav1.NamespaceDefault,
		},
		Spec: MinecraftServerController.MinecraftServerSpec{
...
func (f *fixture) newController(ctx context.Context) (*Controller, informers.SharedInformerFactory, kubeinformers.SharedInformerFactory) {
	...
	c := NewController(ctx, f.kubeclient, f.client,
		k8sI.Apps().V1().Deployments(), i.Minecraftserver().V1alpha1().MinecraftServers())
			//k8sI.Apps().V1().Deployments(), i.Samplecontroller().V1alpha1().Foos())

	c.minecraftServerSynced = alwaysReady
